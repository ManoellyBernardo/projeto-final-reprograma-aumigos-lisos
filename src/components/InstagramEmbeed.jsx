...
const InstagramEmbed = () => {
  return (
    <blockquote
      ...
      data-instgrm-permalink="https://www.instagram.com/p/Cuw-QbbLT9b/?utm_source=ig_embed&amp;utm_campaign=loading"
    ...
    >
      <div style={{ padding: '16px' }}>
        <a
          href="https://www.instagram.com/p/Cuw-QbbLT9b/?utm_source=ig_embed&amp;utm_campaign=loading"
          style={{
            background: '#FFFFFF',
            lineHeight: '0',
            padding: '0 0',
        ...
        >
          <a href="https://www.instagram.com/p/Cuw-QbbLT9b/?utm_source=ig_embed&amp;utm_campaign=loading" style={{ color: '#c9c8cd', fontFamily: 'Arial, sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal', lineHeight: '17px', textDecoration: 'none' }} target="_blank">
            Uma publicação compartilhada por nome_usuario (@nome_usuario)
          </a>
          <time datetime="2022-04-10T15:06:29+00:00" style={{ fontFamily: 'Arial, sans-serif', fontSize: '14px', fontStyle: 'normal', fontWeight: 'normal' }}>
            em Abr 10, 2022 às 8:06 PDT
          </time>
        </p>
      </div>
    </blockquote>
